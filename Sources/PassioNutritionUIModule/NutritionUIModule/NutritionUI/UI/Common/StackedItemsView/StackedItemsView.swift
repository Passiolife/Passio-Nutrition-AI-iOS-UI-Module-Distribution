...
public class StackedItemsView<ItemType: Equatable, CellType: UICollectionViewCell>: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UIContextMenuInteractionDelegate, UIDragInteractionDelegate {
    ...
    public typealias ConfigureItemHandler = (String, SentMultiImageCollectionViewCell) -> Void
    ...
    public func cell(at index: Int) -> SentMultiImageCollectionViewCell? {
        return collectionView.cellForItem(at: IndexPath(row: index, section: 0)) as? SentMultiImageCollectionViewCell
    }
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let tCell = cell as? SentMultiImageCollectionViewCell {
            configureItemHandler?(items[indexPath.row] as! String, tCell)
        }
    ...
    private func setup() {
        ...
        collectionView.register(SentMultiImageCollectionViewCell.self, forCellWithReuseIdentifier: reuseIdentifier)
    ...
    private var targetedDragPreviewForCurrentCell: UITargetedDragPreview? {
        guard let cell = cell(at: currentlyFocusedItemIndex) 
        else { return nil }
