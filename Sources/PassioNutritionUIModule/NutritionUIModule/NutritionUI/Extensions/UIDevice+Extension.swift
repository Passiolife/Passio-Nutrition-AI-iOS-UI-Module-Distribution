...
//  BaseApp
//
//  Created by Nikunj Prajapati on 29/03/22.
...
//            return safeAreaInsets.top > 20 // Adjust this threshold as needed
//        }
//        return false
//    }
...
//            }
//        }
//        // passioLogEng(message: "UIDevice().model =\(UIDevice().type.rawValue)")
//        // passioLogEng(message: "modelCode  = \(String(describing: modelCode))")
//        let modelMap: [String: DeviceModelApp] = [
//
//            // Simulator
//            "i386": .simulator,
//            "x86_64": .simulator,
